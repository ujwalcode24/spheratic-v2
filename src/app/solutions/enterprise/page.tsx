        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-accent-gray-600 max-w-4xl mx-auto leading-relaxed">
              Enterprise resource planning, workflow automation, and business intelligence solutions.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-accent-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-accent-gray-600">
              See the impact on operations and profitability.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-accent-gray-600">
              Solutions for various enterprise sectors.
            </p>
          </motion.div>
