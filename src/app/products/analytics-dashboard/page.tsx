...
const AnalyticsDashboardPage = () => {
  ...
  const benefits = [
    { number: '80%', label: 'Faster Insights' },
    { number: '100+', label: 'Data Sources' },
    { number: '1000+', label: 'Metrics' },
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Enterprises', description: 'Monitor company-wide metrics', icon: '🏢' },
              { title: 'Startups', description: 'Track growth and KPIs', icon: '🚀' },
              { title: 'Agencies', description: 'Manage client dashboards', icon: '📊' }
            ].map((useCase, index) => (
              <motion.div
                key={useCase.title}
