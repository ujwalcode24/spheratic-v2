...
import { Building2, CreditCard, Shield, CheckSquare, BarChart3, Link2 } from 'lucide-react';

const FinTechSuitePage = () => {
  const features = [
    {
      title: 'Digital Banking',
      description: 'Complete digital banking platform with mobile apps and web interfaces',
      icon: Building2
    },
    {
      title: 'Payment Processing',
      description: 'Real-time payment processing with multiple currency support',
      icon: CreditCard
    },
    {
    ...
    },
    {
      ...
      description: 'Built-in compliance and regulatory reporting tools',
      icon: CheckSquare
    },
    {
      title: 'Analytics',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-accent-gray-600 max-w-4xl mx-auto leading-relaxed">
              Complete financial technology solutions for modern banking and payments.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Banks', description: 'Digital transformation for traditional banks', icon: '🏦' },
              { title: 'Fintech Startups', description: 'Launch your fintech platform quickly', icon: '🚀' },
              { title: 'Payment Processors', description: 'Scale your payment processing', icon: '💰' }
            ].map((useCase, index) => (
              <motion.div
                key={useCase.title}
      ...
      <FullWidthSection variant="orange">
        ...
        >
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Get started with FinTech Suite today.
          </p>
