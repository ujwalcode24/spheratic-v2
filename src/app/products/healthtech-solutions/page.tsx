        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-accent-gray-600 max-w-4xl mx-auto leading-relaxed">
              Advanced healthcare technology for better patient outcomes.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Hospitals', description: 'Streamline hospital operations', icon: '🏥' },
              { title: 'Clinics', description: 'Enhance patient care delivery', icon: '⚕️' },
              { title: 'Telemedicine', description: 'Launch remote care services', icon: '📱' }
            ].map((useCase, index) => (
              <motion.div
                key={useCase.title}
      ...
      <FullWidthSection variant="orange">
        ...
        >
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
            Get started with HealthTech Solutions today.
          </p>
