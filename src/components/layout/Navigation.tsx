                    ...
                    <AnimatePresence>
                      {activeDropdown === item.label && (
                        <motion.div
                          ...
                          className="absolute top-full left-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-accent-gray-200 py-4 z-50 backdrop-blur-md"
                        >
                          ...
                          {item.children.map((child) => (
                            ...
                            >
                              <div className="flex-shrink-0 w-8 h-8 bg-primary-100 rounded-lg flex items-center justify-center mr-3 group-hover:bg-primary-200 transition-colors duration-200">
